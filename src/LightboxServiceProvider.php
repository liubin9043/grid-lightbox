...
class LightboxServiceProvider extends ServiceProvider
{
    ...
    public function boot(Lightbox $extension)
    {
        ...
        if ($this->app->runningInConsole() && $assets = $extension->assets()) {
            $this->publishes(
                [$assets => public_path('vendor/laravel-admin-extend/grid-lightbox')],
        ...
        Admin::booting(function () {
            ...
            Admin::css('vendor/laravel-admin-extend/grid-lightbox/magnific-popup.css');
            Admin::js('vendor/laravel-admin-extend/grid-lightbox/jquery.magnific-popup.min.js');
